...
int melody[] = {
NOTE_D4, NOTE_F4, NOTE_D4, NOTE_D4, NOTE_G4, NOTE_D4, NOTE_C4,
NOTE_D4, NOTE_A4, NOTE_D4, NOTE_D4, NOTE_AS4, NOTE_A4, NOTE_F4, //Check A5 and B5 for an error
NOTE_D4, NOTE_A4, NOTE_D5, NOTE_D4, NOTE_C4, NOTE_C4, NOTE_A3, NOTE_E4, NOTE_D4,
0, NOTE_D4, NOTE_D4,
};
...
void turnLeftUTurnBlocking(MeDCMotor *leftMotor, MeDCMotor *rightMotor)
{
  turnLeftBlocking(leftMotor, rightMotor);
//  delay(500);
  moveStraightBlocking(leftMotor, rightMotor, 1200);
//  delay(500);
  turnLeftBlocking(leftMotor, rightMotor);
//  delay(500);
  leftMotor->stop();
...
void turnRightUTurnBlocking(MeDCMotor *leftMotor, MeDCMotor *rightMotor)
{
  turnRightBlocking(leftMotor, rightMotor);
//  delay(500);
  moveStraightBlocking(leftMotor, rightMotor, 1100);
//  delay(500);
  turnRightBlocking(leftMotor, rightMotor);
//  delay(500);
  leftMotor->stop();
